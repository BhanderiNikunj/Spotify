...
class HomeProvider extends ChangeNotifier {
  ...
  List<Audio> PlayList1 = [
    ...
    Audio("Assets/Audio/PlayList1/The Mafia Raaj.mp3"),
    Audio("Assets/Audio/PlayList1/Rayfale Rahda Ramade.mp3"),
    Audio("Assets/Audio/PlayList1/Rona Ser Ma.mp3"),
    Audio("Assets/Audio/PlayList1/Lagyo Prityu No Rang.mp3"),
    Audio("Assets/Audio/PlayList1/Nanpan No Nedlo.mp3"),
  ];
  List PlayListName1 = [
    "AUKAAT",
    "Rayfal 3 Reload",
  ...
  List<Audio> PlayList4 = [
    Audio("Assets/Images/PlayList3/King.mp3"),
    Audio("Assets/Images/PlayList3/295.mp3"),
    Audio("Assets/Images/PlayList3/BROWN MUNDE.mp3"),
    Audio("Assets/Images/PlayList3/Outlaw.mp3"),
    Audio("Assets/Images/PlayList3/SARKAR.mp3"),
  ...
  List PlayListImage4 = [
    "Assets/Images/PlayList3/295.jpg",
    "Assets/Images/PlayList3/King.jpg",
    "Assets/Images/PlayList3/BROWN MUNDE.jpg",
    "Assets/Images/PlayList3/Outlaw.jpg",
    "Assets/Images/PlayList3/SARKAR.jpg",
  ];
