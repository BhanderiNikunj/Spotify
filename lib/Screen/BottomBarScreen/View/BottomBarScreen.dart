...
class _BottomBarScreenState extends State<BottomBarScreen> {
  ...
  Widget build(BuildContext context) {
    bottomBarScreenProviderfalse = Provider.of<BottomBarScreenProvider>(context,listen: false);
    bottomBarScreenProvidertrue = Provider.of<BottomBarScreenProvider>(context,listen: true);
    return SafeArea(
      child: Scaffold(
        body: bottomBarScreenProviderfalse!.Screens[bottomBarScreenProvidertrue!.i],
